...
def tg_send(original, link):
    ...
    VIDEO = {"video": link, "reply_markup": KEYBOARD, "caption": "_*Discord Cross-Platform*_"}
    URL = f"[14](https://api.telegram.org/bot{tg_token}/sendVideo?chat_id=contentdownload"
